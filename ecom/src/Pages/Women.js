...
const Womens = ({search}) => {
  ...
  return (
    ...
    <div className="item">
          <img
            src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/web-banner_3_zzhisEJ.jpg?format=webp&w=1366&dpr=1.0"
            alt=""
          />
        </div>
        <div className="item">
          <img
            src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/Homepage_banner_1_copy_Gf2dye2.jpg?format=webp&w=1366&dpr=1.0"
            alt=""
          />
        </div>
        <div className="item">
          <img
            src="https://prod-img.thesouledstore.com/public/theSoul/storage/mobile-cms-media-prod/banner-images/Homepage_banner.jpg?format=webp&w=1366&dpr=1.0"
            alt=""
          />
        </div>
        <div className="item">
          <img
            src="https://prod-img.thesouledstore.com/public/theSoul/uploads/catalog/category/catban-020240126114012.jpg?format=webp&w=1366&dpr=1.0"
            alt=""
          />
        </div>
      </OwlCarousel>
